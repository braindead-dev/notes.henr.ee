...
We use military grade **AES-256** encryption with **PBKDF2 key derivation** supported. Your paste's content is encrypted before it ever reaches our servers, so that no one, not even us, can access your paste's content without your password / key.
